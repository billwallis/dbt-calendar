...
select
    ...
    -- day_of_week_number = 1 as is_week_start,
    -- day_of_week_number = 0 as is_week_end,  /* TODO: Align the weekly attributes to be consistent */
    day_of_month_number = 1 as is_month_start,
    ...
    day_of_year_number = 1 as is_year_start,
